...
public class SecurityBeansConfig {
    ...
    @Bean
    public DefaultWebSecurityExpressionHandler webSecurityExpressionHandlerOther(@Qualifier("defaultPermissionEvaluator") PermissionEvaluator permissionEvaluator) {
